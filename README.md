# 2026最新免费社工库排行(各位看官，麻烦给个star关注一下)

永久免费社工库是指可以免费使用的telegram社工库机器人,2026最新免费高质量Telegram电报社工库机器人和在线社工库查询网站，定期删除无法使用的社工库，这些免费社工库功能各异，如小红书社工库/微信社工库/手机定位社工库/酒店开房记录查询社工库等，都是基于泄漏隐私数据，看看你是否也处于数据外泄事件之中。
...
天眼社工库提供官方社工库查询接口,是一个免费telegram社工库查询机器人,社工库查照片机器人,新用户加入即可免费使用,体验还不错.
...
全网最强免费社工库天机阁工库,新推出的在线社工库telegram查询工具,目前初次使用用户可免费使用5次,后续可以通过签到方式获得积分继续使用.
...
免费永旺社工库是一个强势新出的社工库机器人和社工库查询工具，此社工库可查询到: 身份户籍、开房记录、企业信息、事业单位、贷款记录、车牌车主、电话机主、学籍信息、收货信息、常用密码、外卖订单等。开盒必备社工库，这个社工库貌似跟前面的那个智网是同一个。智网社工库换账号地址了。
...
免费智网社工库是已泄露用户数据查询工具，每日有三次免费查询次数，智网综合社工库可以查询车牌（全国车主），也可以查询姓名，手机号，性别，年龄，身份证号、微博号、QQ号、快递地址、收件姓名。这个社工库跟后面的永旺社工库账号合并了，直接看下面的吧。
...
喜力社工库是一个最新免费手机号社工库,免费自助查询社工库,自然语言猎魔社工库，查询三网机主轨迹，微信号查询社工库，可以免费使用的社工库，很强大的社工库。

* 账号：<a href="https://www.mfsgk.com/230.html" target="_blank">@gnoranceX2025bot</a>。
* 教程见: <a href="#使用教程" target="_blank" >视频教程</a>。

## 星盾社工机器人⭐⭐⭐⭐

星盾社工库是一个免费高质量社工库查询机器人，数据质量还可以，查询免费，解锁金币或钻石，分享可以获得金币，钻石就需要充值了，我穷，充不起，看看得了。
...
小红书社工库可以免费使用，支持查询海量地址信息/电信营业厅信息/QQ号绑定信息/手机号实名信息等。

* 最新社工库软件下载及使用：<a href="https://www.mfsgk.com/139.html" target="_blank">小红书社工库机器人 – 小红书开户机器人</a>；


## 小熊免费社工库⭐⭐⭐⭐

小熊免费社工库支持免费查询手机定位/通话记录/微博绑定等信息，但是免费测试了一下，返回的信息并没有前面的社工库查询工具返回的多，原账号被telegram官方注销，目前已更新。
...
云查查社工库是一个微信社工库查询机器人,提供微信绑定信息查询功能.可根据QQ号码/手机号关联查询绑定实名信息/携程旅行记录等,真实性自行验证。请不要充值使用。
...
无名社工库拥有最新社工库数据库,无名社工库支持根据姓名模糊查询，也可以发送QQ号码、手机号、身份证号等信息进行查询，有新用户奖励，可以免费使用的Telegram在线社工库。
...
Hope社工库是一个免费社工库网站,可以进行模糊搜索，数据不错的社工库，支持微信绑定、QQ绑定、手机IMEI信息库、快递信息、三要素信息、微博绑定、支付宝信息、全国法人数据的查询。
...
黑盒社工库是一个免费社工库微信信息查询工具,可以查询某人开房记录及同住人员信息,好用的社工库猎魔查询工具，免费使用，需要积分，但是可以通过首次使用赠送、分享好友等方式获取积分。
...
繁花社工库是一个知名海外社工库查询工具,支持身份证补齐的社工库机器人，查询免费，查询结果大码，需要积分解锁结果，支持签到和分享获取积分。
...
* 教程：<a href="https://www.shegongku.top/179.html" target="_blank">社工库2025微信、小红书开户反查</a>。

## 杰拉德社工库机器人社工库⭐⭐⭐⭐

杰拉德社工库提供免费信息查询服务,原红鼻子社工库打造新产品，数据搭载138000000条二要素数据，覆盖了全国95%的人口信息，之前泄露的上海10e数据也在导入中，感谢网友提供的分享。
...
好用的免费社工库推荐,手机号社工库是指可以查询手机号绑定信息的telegram社工库机器人,号称永久免费，支持猎魔、身份证补齐等操作。查询操作在群内进行，群内有操作提示消息，需要按照群内的操作指令来进行查询。大体如下：
...
诗人社工库拥有海量隐私数据的社工库接口,独具特色的真地址开盒社工库，个户数据开户及联通记住信息查询，自称全网最强个户机器人。
...
Space社工库拥有最新人员信息数据库,支持身份户籍查询、快递地址查询、开房记录、QQ绑定信息、微博绑定信息，隐私信息免费查询，解锁需要积分，可以通过分享获得积分。
...
差佬查免费社工库是一个专业免费社工库查照片工具,可以查询身份证证件地址，手机机主，车牌查询等信息。发送身份证(含台湾)、邮箱、姓名、QQ号、手机号、微信原始ID、微博ID、账号名、企业统一信用编码,手机串号,快手uid,推特uid,facebook uid,手机串号即可查询。
...
一个免费社工库，个户机器人，根据身份证号码生成真实个人头像和户籍地址。包括白底、身份证反正面，这个不免费，所以没尝试，没有免费功能，不建议使用。
...
日月社工库是一个知名个人信息查询社工库,原日月社工库机器人被注销了，目前换了账号了，综合数据社工库，号称永久免费的社工库，查开户，查婚姻，查开房记录，查银行流水，返回数据挺全。功能应该是恢复正常了，看群组里很多人在用。
...
* <a href="https://github.com/wwwwho/mfsgk" target="_blank" >最新免费社工库列表</a>
